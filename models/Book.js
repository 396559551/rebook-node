...
class Book {
    ...
    createBookFromFile(file) {
        ...
        this.unzipUrl = unzipUrl//解压文件夹连接
        this.title = ''//书名
        this.author = ''//作者
        this.publisher = ''//出版社
        this.contents = []//目录
        ...
        this.cotegory = -1//分类ID
        this.categoryText = ''//分类名称
        this.language = ''//语种
        this.originalName = originalname//原名
    }
                   ...
                   if (!title) {
                       ...
                       const handleGetImage = (err,file,mimeType) => {
                           if (err) {
                               ...
                               fs.writeFileSync(coverPath, file, 'binary')//写入磁盘空间
    ...
    parseContents(epub) {
        ...
        if (fs.existsSync(ncxFilePath)) {
            return new Promise((resolve, reject) => {
                const xml = fs.readFileSync(ncxFilePath, 'utf-8')// 将ncx文件从xml转为json
                ...
                xml2js(xml, {
                    ...
                    if (err) {
                        ...
                        if (navMap.navPoint && navMap.navPoint.length > 0) {
                            ...
                            const newNavMap = flatten(navMap.navPoint)//扁平navMap.navPoint
                            const chapters = []
